...
function UGFunctions() {
    ...
    this.debugVar = "", this.z__________FULL_SCREEN___________ = function() {}, this.toFullscreen = function(e, t) {
        ...
        if (1 == t)
            l = h.height * g, u = h.width * g, 0 != b && (m = -(b * g - b)), 0 != y && (v = -(y * g - y));
        else {
            l = h.height / g, u = h.width / g;
            var E = i.getImageInsideParentData(c, p.width, p.height, o, s);
            if (u < E.imageWidth)
                return i.scaleImageFitParent(e, p.width, p.height, o, s), !0;
            1 == f && (0 != b && (m = -(b / g - b)), 0 != y && (v = -(y / g - y)))
        }
        if (a) {
            var T = 1;
            if (0 != p.width && (T = u / p.width), T > a)
                return !1
        }
        ...
        if (-1 !== n.isRgbaSupported)
            return n.isRgbaSupported;
        ...
        return 0 == o && t ? (t(), !1) : void setTimeout(function() {
            for (var t = 0; o > t; t++) {
                var i = e[t];
                if (void 0 !== i.naturalWidth && 0 !== i.naturalWidth)
                    n(e[t], !1);
                else {
                    var r = jQuery("<img/>");
...
function UGThumbsGeneral() {
    ...
    function a() {
        if (x.thumb_round_corners_radius <= 0)
            return !1;
        var e = {
    ...
    function u(t, i, n) {
        if (1 == x.thumb_fixed_size)
            P.scaleImageCoverParent(i, t);
        else {
    ...
    this.init = function(e, t) {
        ...
        if (w.children(".ug-thumb-wrapper").each(function() {
            ...
            if (P.isRgbaSupported()) {
                ...
                t["background-color"] = x.thumb_overlay_color, j.colorOverlayOpacity = x.thumb_overlay_opacity;
        ...
        if (j.customThumbs = !0, "function" != typeof e)
    ...
    function s() {
        ...
        for (0 == H && (n = k.strip_padding_top), i = 0; i < e.length; i++) {
            ...
            if (1 == R.isNotFixedThumbs) {
                if (objItem = N.getItemByThumb(r), 0 == objItem.isLoaded)
                    continue;
                r.show()
            }
        ...
        if (0 == H)
            ...
            var o = n - k.strip_space_between_thumbs;
        a(o)
    }
    function l() {
        if (0 == H) {
...
function UGPanelsBase() {
    ...
    this.init = function(e, t, i, o, l) {
        ...
        if (o = e, "strip" == n.panelType)
            var t = a.strippanel_enable_handle;
        else
            var t = a.gridpanel_enable_handle;
...
function UGStripPanel() {
    ...
    function c() {
        if (!y)
            return !0;
        if (0 == P.isMoveEnabled())
            return S.disableButton(I), S.disableButton(y), !0;
...
function UGGridPanel() {
    ...
    function l() {
        var e = !1;
        if (1 == M.gridpanel_arrows_always_on)
            e = !0;
        else {
            var t = C.getNumPanes();
            t > 1 && (e = !0)
    ...
    this.destroy = function() {
        ...
        if (1 == L.isHorType)
            throw new Error("setHeight is not appliable to this orientatio (" + L.orientation + "). Please use setWidth");
        L.panelHeight = e;
        var t = a();
        C.setMaxHeight(t)
    }, this.setWidth = function(e) {
        if (0 == L.isHorType)
            throw new Error("setWidth is not appliable to this orientatio (" + L.orientation + "). Please use setHeight");
        L.panelWidth = e;
        var t = s();
        C.setMaxWidth(t)
    }, this.init = function(t, i) {
...
function UGThumbsGrid() {
    function e(e, t, i) {
        if (N = e.getObjects(), F = e, F.attachThumbsPanel("grid", Q), H = jQuery(e), k = N.g_objWrapper, R = N.g_arrItems, i === !0 && (X.isTilesMode = !0), X.numThumbs = R.length, _(t), 1 == X.isTilesMode) {
            ...
            t.thumb_fixed_size = !0, Y.init(e, t)
    }
    function t(e) {
        var t = k;
    ...
    function n() {
        ...
        } else if (0 == X.gridWidth)
            throw new Error("You must set width before run.")
    }
    function r() {
        var e = F.getSelectedItem();
        if (n(), 1 == X.isFirstTimeRun)
            L(), 1 == X.isTilesMode ? (a(), u(), U.run()) : (Y.setHtmlProperties(), u(), Y.loadThumbsImages());
    ...
    function o() {
        if (1 == X.isTilesMode)
            var e = U.getGlobalTileSize();
        else
            var e = Y.getGlobalThumbSize();
        return e
    }
    function a() {
        if (0 == X.isTilesMode)
    ...
    function A() {
        if (0 == V.grid_vertical_scroll_ondrag)
            return !1;
        if (1 == X.isNavigationVertical)
            return !1;
...
function UGTiles() {
    ...
    function u() {
        if (le.colWidth = ue.tiles_col_width, le.minCols = ue.tiles_min_columns, le.maxCols = ue.tiles_max_columns, 0 == re.isMobileMode() ? le.colGap = ue.tiles_space_between_cols : le.colGap = ue.tiles_space_between_cols_mobile, le.galleryWidth = r(), le.availWidth = le.galleryWidth, 1 == ue.tiles_include_padding && (le.availWidth = le.galleryWidth - 2 * le.colGap), 1 == ue.tiles_exact_width)
            le.numCols = oe.getNumItemsInSpace(le.availWidth, le.colWidth, le.colGap), le.maxCols > 0 && le.numCols > le.maxCols && (le.numCols = le.maxCols), le.numCols < le.minCols ? (le.numCols = le.minCols, l()) : le.totalWidth = le.numCols * (le.colWidth + le.colGap) - le.colGap;
        else {
    ...
    function d() {
        ...
        for (col = 0; col < le.numCols; col++) {
            if (void 0 == le.colHeights[col] || 0 == le.colHeights[col])
                return col;
    ...
    function _(e, t, i, n) {
        ...
        if (null === o) {
            if (1 == ue.tiles_enable_transition)
    ...
    function f() {
        ...
        if (1 == de.isFixedMode)
            ne.trigger(ie.events.TILES_FIRST_PLACED), g(!0), oe.checkImagesLoaded(o, function() {
    ...
    function S(e, t) {
        if (0 == t) {
            for (var i = _e.currentItem; i < te.length; i++)
                x(i, !0);
            _e.currentItem = te.length - 1
        } else
            x(_e.currentItem, !0);
        for (var i = 0; i <= _e.currentItem; i++)
            U(i, !0);
        _e.currentItem++
    }
    function P(e) {
        if (1 == ue.tiles_nested_debug)
            return "undefined" == typeof e && (e = !0), S(!0, e), !1;
    ...
    function j(e, t, i) {
        ...
        if (s)
            ...
            a >= 4 ? 1 == R(Math.floor(t / 2), i) ? H(e, Math.floor(t / 2) + 1) : H(e, Math.floor(t / 2)) : H(objImage, t);
        else if (1 == R(r, i))
            switch (r >= a) {
            case !0:
                H(e, r - 1);
    ...
    function O(e, t) {
        for (var i = 0, n = 0, r = [], o = 0, a = 0, s = 0; s < e[1].length; s++) {
            var l = e[1][s],
                u = te[e[1][s]];
            if (n += u.dimHeight, 0 != s)
                i += u.dimHeight, r.push([l, u.dimHeight]);
            else {
                var d = H(l, t, !0);
    ...
    function z(e, t, i) {
        ...
        if (s.push(e), n >= 0) {
            for (o = 0; n >= 0;) {
                if (r = ee[n][i], "undefined" != typeof ee[n][i - 1] && ee[n][i - 1] == ee[n][i] || "undefined" != typeof ee[n][i + t] && ee[n][i + t - 1] == ee[n][i + t] || ee[n][i] != ee[n][i + t - 1])
    ...
    function L(e, t) {
        ...
        if ("undefined" == typeof l[_e.gridY] || "undefined" == typeof l[_e.gridY][e - 1])
            n = 0;
        else
            for (var u = 0;;) {
                if ("undefined" == typeof ee[_e.gridY + u] || -1 == ee[_e.gridY + u][e - 1])
                    break;
                a = ee[_e.gridY + u][e - 2], u++, n++
            }
        if ("undefined" == typeof l[_e.gridY] || "undefined" == typeof l[_e.gridY][e + r])
            i = 0;
        else
            for (u = 0;;) {
                if ("undefined" == typeof ee[_e.gridY + u] || -1 == ee[_e.gridY + u][e + r])
                    break;
    ...
    function Q(e, t, i, n) {
        for (var r = 0; r < t.dimHeight; r++)
            for (var o = 0; o < t.dimWidth; o++)
                0 == D(n + r) && W(n + r), B(n + r, i + o, e)
    }
    function W(e) {
        ee[e] = new Object;
        for (var t = 0; t < _e.maxColumns; t++)
            ee[e][t] = -1
    }
    function F(e, t) {
        return -1 != ee[e][t]
...
function UGTileDesign() {
    ...
    function n(e, t) {
        if (e.addClass("ug-tile"), Y.funcCustomTileHtml)
            return Y.funcCustomTileHtml(e, t), !1;
        var i = "";
        ...
        if (F.tile_enable_icons) {
            ...
            if (t.link && 1 == F.tile_show_link_icon || 1 == F.tile_as_link)
                if (0 == F.tile_as_link) {
                    ...
                    s += "<div class='ug-tile-icon ug-icon-link' style='display:none'></div>";
            var _ = Y.isSaparateIcons;
            if (0 == _ && "image" != t.type && 1 == Y.isVideoplayIconAlwaysOn && (_ = !0), _)
                var g = e;
            else
                var g = e.children(".ug-thumb-overlay");
            g.append(s);
            var c = g.children("." + l);
            ...
            1 == F.tile_enable_action && e.addClass("ug-tile-clickable");
    ...
    function h(e, t) {
        ...
        case R.sizeby.IMAGE_RATIO:
            ...
            if ("undefined" != typeof n.thumbRatioByHeight) {
                if (0 == n.thumbRatioByHeight)
                    throw trace(n), new Error("the item ratio not inited yet");
    ...
    function b(e, t, i, n) {
        ...
        if (0 == F.tile_enable_image_effect)
            Q.scaleImageCoverParent(l, t, i), 0 == Y.hasImageContainer && null !== d && Q.placeElement(l, 0, d);
        else {
            var h = "nothing";
    ...
    function I(e) {
        ...
        if (t && i) {
            ...
            t && Q.placeElement(t, "center", "middle", 0, _), i && Q.placeElement(i, "center", "middle", 0, _);
        t && t.show(), i && i.show()
    }
    function w(e, t) {
        ...
        if (0 == F.tile_image_effect_reverse) {
            ...
            t ? i.stop(!0).fadeTo(n, 1) : i.stop(!0).fadeTo(n, 0)
    }
    function E(e, t) {
        ...
        if ("slide" == F.tile_textpanel_appear_type) {
            ...
            1 == t ? n.stop(!0).fadeTo(i, 1) : n.stop(!0).fadeTo(i, 0)
    }
    function T(e, t, i) {
    ...
    function M(e) {
        var t = jQuery(this),
            ...
            n = !0;
        if (Y.funcParentApproveClick && 0 == Y.funcParentApproveClick() && (n = !1), "a" == i)
    ...
    this.loadTileImage = function(e) {
        ...
        if (1 == Y.isTextpanelOutside && y(e, "clone", t), t) {
            if (!i)
                var i = R.getTileHeightByWidth(t, e, "resizeTile")
        } else
            var t = F.tile_width,
                i = F.tile_height;
        ...
        case R.resizemode.VISIBLE_ELEMENTS:
            if (Y.funcCustomTileHtml)
                return R.triggerSizeChangeEvent(e, !0), !0;
        ...
        if (F.tile_size_by !== R.sizeby.GLOBAL_RATIO)
...
function UGAviaControl() {
    ...
    function t(t) {
        jQuery("body").on("touchstart", function(e) {
            ...
            if (0 == f.isControlEnabled)
                return !0;
            if (1 == f.touchEnabled)
                return jQuery("body").off("mousemove"), !0;
...
function UGSlider() {
    ...
    function t() {
        ...
        if (xe.isRunOnce = !0, Se.slider_background_color) {
            ...
            1 != Se.slider_background_opacity && (e = we.convertHexToRGB("#000000", Se.slider_background_opacity), re.css("background-color", e));
    ...
    function a() {
        if (ye && (objBullets = ye.getElement(), we.placeElement(objBullets, Se.slider_bullets_align_hor, Se.slider_bullets_align_vert, Se.slider_bullets_offset_hor, Se.slider_bullets_offset_vert), we.placeElement(objBullets, Se.slider_bullets_align_hor, Se.slider_bullets_align_vert, Se.slider_bullets_offset_hor, Se.slider_bullets_offset_vert)), 1 == Se.slider_enable_arrows && (we.placeElement(ue, Se.slider_arrow_left_align_hor, Se.slider_arrow_left_align_vert, Se.slider_arrow_left_offset_hor, Se.slider_arrow_left_offset_vert), we.placeElement(de, Se.slider_arrow_right_align_hor, Se.slider_arrow_left_align_vert, Se.slider_arrow_right_offset_hor, Se.slider_arrow_right_offset_vert)), 0 == Se.slider_controls_always_on && M(!0), Ee) {
            ...
            if ("bar" == Se.slider_progress_indicator_type) {
                ...
                we.placeElement(e, Se.slider_progress_indicator_align_hor, Se.slider_progress_indicator_align_vert, Se.slider_progress_indicator_offset_hor, Se.slider_progress_indicator_offset_vert)
        }
    ...
    function g(e, t) {
        ...
        var n = we.getElementSize(e),
            r = n.width,
            o = n.height;
        if (t && (t.hasOwnProperty("imageWidth") && (r = t.imageWidth), t.hasOwnProperty("imageHeight") && (o = t.imageHeight)), 0 >= r)
            return i;
        var a = o > r ? r : o,
            s = 2 * i,
            l = s / a;
        if (l < Se.slider_image_border_maxratio)
            return i;
    ...
    function p(e, t, i) {
        var n = e.children(".ug-item-wrapper"),
            r = J(e);
        if ("undefined" == typeof t.urlImage || "" == t.urlImage)
        ...
        if (objPadding = pe.getObjImagePadding(), a == o && i !== !0) {
            ...
            if (u.fadeTo(0, 1), _(r), "image" != l && 1 == Se.slider_video_constantsize)
                var g = h(u, t);
            else
                var g = we.getImageInsideParentData(n, t.imageWidth, t.imageHeight, s, objPadding);
            u.css("width", g.imageWidth + "px"), c(u, l, g), fe.trigger(pe.events.AFTER_PUT_IMAGE, e)
        } else
            u.fadeTo(0, 0), d(r), e.data("isLoading", !0), pe.isSlideCurrent(e) && fe.trigger(pe.events.CURRENTSLIDE_LOAD_START), u.data("itemIndex", t.index), u.on("load", function() {
                var e = jQuery(this),
                    t = e.data("itemIndex");
                e.fadeTo(0, 1);
    ...
    function f(e, t) {
        try {
            ...
            if (null == t)
                return i.html(""), e.removeData("index"), e.removeData("type"), e.removeData("urlImage"), !1;
            e.data("index");
    ...
    function y(e, t) {
        if (void 0 == t)
            var t = pe.getCurrentSlide();
        var i = pe.getSlideType(t);
        if (i != e)
            throw new Error("Wrong slide type: " + i + ", should be: " + e);
        return !0
    }
    function I() {
        ...
        if (1 == Se.slider_video_constantsize) {
            ...
            n += Se.slider_video_padding_left, r += Se.slider_video_padding_top;
        Ie.setPosition(n, r)
    }
    function w() {
            ...
            d = {
                ...
                always: function() {
                    if (pe.stopSlideAction(), Ie.hide(), null != xe.itemWaiting) {
                        ...
                        pe.placeNabourItems(), fe.trigger(pe.events.TRANSITION_END)
                }
            };
        oe.animate({
            left: o + "px"
    ...
    function M(e) {
        if (0 == we.isTimePassed("sliderControlsToggle"))
            return !1;
        if (0 == xe.isControlsVisible)
            return !1;
        if (!e)
            var e = !1;
        var t = A();
    ...
    this.switchSlideNums = function(e) {
        ...
        var a = void 0 == r;
        if (a)
            f(n.objCurrentSlide, e), pe.placeNabourItems();
        else {
            var s = "left";
            me.getNumItems();
        ...
        if ("image" != _ && 1 == Se.slider_video_constantsize)
            w();
        else {
...
function UGTextPanel() {
    ...
    this.positionElements = function(t) {
        if (!v.textpanel_height || "top" == v.textpanel_text_valign)
            return e(t), !1;
        ...
        if (b.setInternalHeight = !0, t)
            b.setInternalHeight = !1;
        else
            var t = 80;
...
function UGZoomButtonsPanel() {
    ...
    function n() {
        if (0 == d.isCurrentSlideType("image"))
            return !0;
...
function UGBullets() {
    ...
    this.events = {
        ...
        if (n(e), "number" != typeof e)
            var t = e;
        else
            var t = o.children(".ug-bullet")[e];
...
function UGProgressPie() {
    function e(e) {
        ...
        var o = a.slider_progresspie_width / 2,
            ...
            l = 0,
            u = e * Math.PI * 2;
        if (1 == a.slider_progresspie_type_fill)
            n.beginPath(), n.moveTo(o, s), n.arc(o, s, t, l, u), n.lineTo(o, s), n.fillStyle = a.slider_progresspie_color1, n.fill(), n.closePath();
        else {
...
function UGTouchSliderControl() {
    ...
    function i(e) {
        if (1 == m.isInnerInPlace())
            return !1;
        if (p.trigger(m.events.BEFORE_RETURN), !e)
            var e = m.getSlidesReference();
        var t = v.getElementSize(e.objCurrentSlide),
            i = -t.left;
        h.animate({
    ...
    function o(e) {
        ...
        if (n) {
            ...
            if (1 == r)
                return b.isInitDataValid = !1, !0;
            if (0 == b.isInitDataValid)
                return a(e), !0
        }
        var o = b.startPosx + t;
        if (t > 0 && o > 0)
    ...
    this.isTapEventOccured = function(t) {
        var i = v.getArrTouches(t),
            n = i.length;
        if (0 != n || 0 != b.lastNumTouches)
            return b.lastNumTouches = n, !1;
        b.lastNumTouches = n;
...
function UGZoomSliderControl() {
    ...
    function i() {
        ...
        if (P.objSlide = n.objCurrentSlide, P.objImage = n.objCurrentSlide.find("img"), 0 == P.objImage.length)
            return !1;
    ...
    function s(e) {
        if (void 0 == P.objImage || 0 == P.objImage.length)
            return !0;
        var t = T.getMousePosition(e),
    ...
    function p(e) {
        if (0 == E.isCurrentSlideType("image"))
            return !0;
        i();
    ...
    function f(e) {
        ...
        var n = P.isPanActive,
            o = P.isZoomActive;
        if (0 == E.isInnerInPlace())
            return P.isZoomActive = !1, P.isPanActive = !1, !0;
        if (1 == P.isZoomActive ? _(e) : g(e), 1 == P.isZoomActive)
            P.isPanActive = !1;
        else {
    ...
    this.________EXTERNAL_____________ = function() {}, this.isPanEnabled = function(e, t) {
        if (i(), void 0 == P.objImage || 0 == P.objImage.length)
            return !1;
        if (0 == P.isZoomedOnce)
            return !1;
        if (0 == r(P.objImage, e))
        ...
        if (0 == E.isInnerInPlace())
            return !1;
        if ("left" == t) {
            if (P.objImageSize.right <= P.objParentSize.width)
                return !1
        } else if (P.objImageSize.left >= 0)
            return !1;
        return !0
    }, this.init = function(t, i) {
        e(t, i)
...
function UGYoutubeAPI() {
    ...
    function n() {
        if ("function" != typeof s.getPlayerState)
...
function UniteGalleryMain() {
    ...
    function runGallery(e, i, n, r) {
        ...
        if (o && (g_temp.objCustomOptions = i), 1 == g_temp.isRunFirstTime) {
            if (g_galleryID = e, g_objWrapper = jQuery(g_galleryID), 0 == g_objWrapper.length)
                return trace("div with id: " + g_galleryID + " not found"), !1;
            ...
            if (r && 1 == g_options.gallery_enable_cache && cacheItems(r, n), "noitems" == n)
                return showErrorMessage("No items in this category", ""), !1;
            g_objWrapper.html(n);
            var a = g_objWrapper.children();
    ...
    function fillItemsArray(e) {
        ...
        for (var i = t.isMobileMode(), n = 0, r = 0; r < e.length; r++) {
            ...
            if (u.type = l, "img" == a) {
                ...
                if ("image" == l)
                    throw trace("Problematic gallery item found:"), trace(o), trace("Please look for some third party js script that could add this item to the gallery"), new Error("The item should not be image type");
    ...
    function preloadBigImages() {
        if ("visible" != g_options.gallery_images_preload_type || g_objThumbs || (g_options.gallery_images_preload_type = "minimal"), 1 == g_temp.isAllItemsPreloaded)
            return !0;
    ...
    function checkPreloadItemImage(e) {
        if (1 == e.isBigImageLoadStarted || 1 == e.isBigImageLoaded || 1 == e.isBigImageLoadError)
            return !1;
        switch (g_options.gallery_images_preload_type) {
        default:
        case "minimal":
    ...
    function onKeyPress(e) {
        ...
        if (i.is("textarea") || i.is("select") || i.is("input"))
            return !0;
    ...
    function initEvents() {
        if (g_objWrapper.on("dragstart", function(e) {
            e.preventDefault()
        }), g_objGallery.on(t.events.ITEM_IMAGE_UPDATED, onItemImageUpdated), g_objThumbs)
    ...
    function cacheItems(e, t) {
        if (t) {
            ...
            var i = g_objWrapper.children().clone();
        g_objCache[e] = i
    }
    ...
    this.onItemBigImageLoaded = function(e, t) {
        ...
        if (t !== !0 && 1 == g_numItems)
            return null;
        if (i >= g_numItems) {
            if (1 != g_options.gallery_carousel && t !== !0)
                return null;
            i = 0
        }
        var n = g_arrItems[i];
        ...
        var t = e - 1;
        if (0 > t) {
            if (1 != g_options.gallery_carousel && forceCarousel !== !0)
                return null;
            t = g_numItems - 1
        }
        var i = g_arrItems[t];
        ...
        var r = "html";
        if (1 == i && (r = "json"), !n || "function" != typeof n)
        ...
        if (n || (n = e), 1 == i && (r = !1), 1 == r && g_objCache.hasOwnProperty(n)) {
            ...
            g_objGallery.trigger(t.events.GALLERY_BEFORE_REQUEST_ITEMS), t.ajaxRequest("front_get_cat_items", {
                catid: e
            }, !0, function(e) {
                var i = e.html;
                t.changeItems(i, n)
...
function UGLightbox() {
    ...
    function u(e) {
        ...
        if (a != o.slider_image_padding_bottom) {
            ...
            if (0 == ne.isAnimating())
                return ne.setOptions(s), ne.refreshSlideItems(), !0
        }
        return !1
    }
    function d(e, t) {
    ...
    function g() {
        if (0 == ne.isCurrentSlideType("image"))
            return !0;
        var e = 1 == ne.isCurrentImageInPlace();
        return e
    }
    function c(e, t) {
        if (0 == se.isArrowsInside)
            return !1;
        if (!Z)
            return !1;
        var i = g();
        ...
        if (t === !0) {
            ...
            Z.stop(), q.stop(), re.placeElement(Z, n, r), re.placeElement(q, o, a);
        1 == e && E(t)
    }
    function h(e, t) {
    ...
    function H(e, t) {
        ...
        if ("image" != i && 0 == se.isCompact && ne.isSlideActionActive())
            return !0;
        var n = ne.isPreloading();
        if (1 == n)
            return ee.close("slider"), !0;
...
function UGCarousel() {
    ...
    function i(e, t) {
        if (!t)
            var t = V.initTileHeight / V.initTileWidth * e;
        V.tileWidth = e;
        var i = {
            tile_width: e,
            tile_height: t
    ...
    function g(e, t, i) {
        ...
        for (var r = [], o = 0; t > o; o++) {
            if ("prev" == i)
                var a = W.getPrevItem(n, !0);
            else
                var a = W.getNextItem(n, !0);
            if (!a)
    ...
    function v(e) {
        if (e > a().length - 1)
            throw new Error("Wrogn tile number: " + e)
    }
    function b(e, t) {
        if ("left" == t)
            var i = d();
    ...
    function y(e, t) {
        v(n);
        for (var i = a(), n = i.length, r = 0; e > r; r++)
    ...
    function S() {
        var e = h(),
            ...
            o = 0,
            a = l();
        if (e > V.spaceActionSize)
            i = s(e), b(i, "left"), V.numCurrent += i;
        else if (e < -V.spaceActionSize) {
            var r = s(Math.abs(e));
            y(r, "left"), V.numCurrent -= r
        }
        if (t > V.spaceActionSize ? (n = s(t), b(n, "right")) : t < -V.spaceActionSize && (o = s(Math.abs(t)), y(o, "right")), o > a)
    ...
    function C(e) {
        ...
        var t = null;
        if (1 == U.carousel_vertical_scroll_ondrag && (t = F.handleScrollTop(V.storedEventID)), "vert" === t)
            return !0;
        V.lastMousePos = o(e);
    ...
    this.startAutoplay = function() {
        ...
        if (!e || "object" == typeof e)
            var e = U.carousel_navigation_numtiles;
        var t = f();
        e > t && (e = t);
...
!function(e) {
    ...
    if ("undefined" == typeof e.cssHooks)
        return !1;
    var o,
